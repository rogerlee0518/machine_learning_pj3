...
print("kernel='rbf', gamma is default\n")
clf=svm.SVC(kernel='rbf')
clf.fit(train_data,X)
svmFunction(clf)

print("kernel='rbf', gamma is default, C=1.0\n")
clf=svm.SVC(kernel='rbf', C=1.0)
clf.fit(train_data,X)
svmFunction(clf)

print("kernel='rbf', gamma is default, C=10.0\n")
...
print("kernel='rbf', gamma is default, C=30.0\n")
clf=svm.SVC(kernel='rbf', C=30.0)
clf.fit(train_data,X)
svmFunction(clf)

print("kernel='rbf', gamma is default, C=40.0\n")
clf=svm.SVC(kernel='rbf', C=40.0)
clf.fit(train_data,X)
svmFunction(clf)

print("kernel='rbf', gamma is default, C=50.0\n")
clf=svm.SVC(kernel='rbf', C=50.0)
clf.fit(train_data,X)
svmFunction(clf)
...
print("kernel='rbf', gamma is default, C=90.0\n")
clf=svm.SVC(kernel='rbf', C=90.0)
clf.fit(train_data,X)
svmFunction(clf)

print("kernel='rbf', gamma is default, C=100.0\n")
